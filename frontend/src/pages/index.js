    ...
    >
      <div className="container">
        <div data-aos="fade-right" className="row">
          ...
          <div data-aos="fade-left" className="col-lg-4 d-sm-block">
            <div>
              <NewAlert />
            </div>
          </div>
        ...
        <div className="row">
          <p className="text-justify col-lg-12 mt-3">
            ...
            high degree of IT usage, and existence of a large number of small
            and medium size manufactures (SMEs) makes Sri Lanka an ideal home
            for fab labs. The benefits of bringing in new technology is the
            ability to transform the manufacturing sector of local economies in
